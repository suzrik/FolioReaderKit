...
@objc public protocol FolioReaderCenterDelegate: class {
    ...
    func readerCenterScrollViewDidScroll(_ scrollView: UIScrollView)
}
...
//    var animator: ZFModalTransitionAnimator!
    ...
    override open func viewDidLoad() {
        ...
        let background = folioReader.isNight(self.readerConfig.nightModeBackground, UIColor(red: 226/255, green: 226/255, blue: 226/255, alpha: 1.0))
    ...
    func configureNavBarButtons() {
        ...
        let starIcon = UIImage(readerImageNamed: "ico_star")?.ignoreSystemTint(withConfiguration: self.readerConfig)
        ...
        let closeIcon = UIImage(readerImageNamed: "ico_back")?.ignoreSystemTint(withConfiguration: self.readerConfig)
        let tocIcon = UIImage(readerImageNamed: "ico_content")?.ignoreSystemTint(withConfiguration: self.readerConfig)
        let fontIcon = UIImage(readerImageNamed: "ico_fonts")?.ignoreSystemTint(withConfiguration: self.readerConfig)
        let space = 12 as CGFloat
        ...
        rightBarIcons.append(UIBarButtonItem(image: starIcon, style: .plain, target: self, action:#selector(favoriteBook)))
...
//        }
    ...
    private func configure(readerPageCell cell: FolioReaderPage?, atIndexPath indexPath: IndexPath) -> UICollectionViewCell {
        ...
        var jsInject = ""
        if readerConfig.scrollDirection == .defaultVertical {
            jsInject = "<script type=\"text/javascript\">setScrollDirection(true)</script>"
        }
...
//                    size.height = size.height - view.safeAreaInsets.bottom
    ...
    open func updateCurrentPage(_ page: FolioReaderPage? = nil, completion: (() -> Void)? = nil) {
        if let page = page {
            currentPage = page
        ...
        currentPage.webView?.js("getReadingTime()", completionHandler: { (readingTime, _) in
    ...
    @objc func favoriteBook(_ sender: UIBarButtonItem) {
    }
    ...
    @objc func shareChapter(_ sender: UIBarButtonItem) {
        ...
        currentPage.webView?.js("getBodyText()", completionHandler: { (chapterText, _) in
    ...
    open func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        delegate?.readerCenterScrollViewDidScroll(scrollView)
...
extension FolioReaderCenter: FolioReaderPageDelegate {
    ...
    public func pageDidLoad(_ page: FolioReaderPage) {
        ...
        folioReader.delegate?.folioReader?(folioReader, didFinishedLoadingPage: page)
    }
